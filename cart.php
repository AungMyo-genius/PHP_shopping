...
<?php
if($_SESSION['user_id'] == null || $_SESSION['logged_in'] == null) {
                          ...
                          ?>
                            <tr>
                                <td>
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="admin/images/<?php echo escape($result['image'])?>" alt="" width="100" height="110">
                                        </div>
                            ...
                            <tr class="out_button_area">
                                ...
                                <td>
                                    <div class="checkout_btn_inner d-flex align-items-center">
                                        ...
                                        <a class="primary-btn" href="sale_order.php">Order to submit</a>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
