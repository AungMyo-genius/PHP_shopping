            ...
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  <div>
                    <a href="cat_add.php" type="submit" class="btn btn-success">New Category</a>
                  </div>
                  <br>
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="btn-group">
                      <div class="container"><a href="cat_edit.php?id=<?php echo escape($value['id'])?>" type="submit" class="btn btn-warning">Edit</a></div>
                      <div class="container"><a href="cat_delete.php?id=<?php echo escape($value['id'])?>"
